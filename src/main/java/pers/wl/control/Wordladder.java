...
public class Wordladder {
    ...
    private static FindLadder printLadder(String word1, String word2, Stack<String>cur_stack) {
        if (ladder_exist) {
            ...
            return new FindLadder(0,"",result);
        }
        else
    ...
    public FindLadder GetLadder(String fileName, String word1, String word2) throws IOException
    {
        ...
        if (!in.exists()) {
            return new FindLadder(1,"Unable to open that file.",new String[]{});
        }
        ...
        while (true) {
            ...
            if(word1.equals("")){
                return new FindLadder(1,"word1 is empty",new String[]{});
            }

            if(word2.equals("")){
                return new FindLadder(1,"word2 is empty",new String[]{});
            }
            word1 = word1.toLowerCase();
            word2 = word2.toLowerCase();
            //several valid tests
            if(word1.length() != word2.length())
                return new FindLadder(1,"The two words must be the same length.",new String[]{});
            else if (word1.equals(word2))
                return new FindLadder(1,"The two words must be different.",new String[]{});
            else {

                if (!(wordSet.contains(word1) && wordSet.contains(word2)))
                    return new FindLadder(1,"The two words must be found in the dictionary.",new String[]{});
                else
